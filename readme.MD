...
To start your project click [this link]

## Background materials

- :exclamation: [Sessions]
- :exclamation: [Salted password hashing](pages/web-security/salted-password-hashing)
- :open_book: [HTTP is statless](pages/web/authentication-http-stateless)
- :open_book: [Cookies](/web/authentication-cookies)
